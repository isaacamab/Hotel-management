...
LOGIN_URL = '/login/'  # Adjust the URL if needed
...
# Session settings
LOGIN_URL = '/login/'  # Login page URL, adjust as needed
...
SESSION_SAVE_EVERY_REQUEST = False  # Save session data every request
